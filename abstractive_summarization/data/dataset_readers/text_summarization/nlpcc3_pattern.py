...
@DatasetReader.register("nlpcc3-pattern")
class NLPCC3PatternDatasetReader(DatasetReader):
    def __init__(self,
    ...
    def text_to_instance(self, source_string: str, target_string: str = None) -> Instance:  # type: ignore
        ...
        tokenized_source_raw,tokenized_source,source = self._source_tokenizer.tokenize(source_string)
        ...
        if target_string is not None:
            tokenized_target_raw,tokenized_target,target = self._target_tokenizer.tokenize(target_string)
            ...
            target = [t if t.startswith('c_') else '' for t in target]
