...
@SimilarityFunction.register("linear-v")
class LinearVSimilarity(SimilarityFunction):
    """
    ...
    def forward(self, tensor_1: torch.Tensor, tensor_2: torch.Tensor) -> torch.Tensor:
        ...
        return torch.matmul(self._activation(dot_product + self._bias),self._V)

    @classmethod
    def from_params(cls, params: Params) -> 'LinearVSimilarity':
        tensor_1_dim = params.pop_int("tensor_1_dim")
        tensor_2_dim = params.pop_int("tensor_2_dim")
        attend_dim = params.pop_int("attend_dim")
